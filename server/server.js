...
io.on('connection', (socket) => {
  ...
  socket.on('accomplishmentStatusChanged', ({ accomplishmentId, employeeId, status }) => {
    // Notify the specific employee
    socket.to(employeeId).emit('accomplishmentStatusChangedAlert', { accomplishmentId, status });
  });
